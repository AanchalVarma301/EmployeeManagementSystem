...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    AddEmployee(){
      ...
      JLabel labelfphone= new JLabel("Phone");
      labelfphone.setBounds(400,250,150,30);
      labelfphone.setFont(new Font("SAN_SERIF",Font.PLAIN,20));
      add(labelfphone); 
     ...
     String courses[] = {"BBA","BCA","B.SC","B.com","BA","B.Tech","M.Sc","MCA","M.Com","MBA","M.Tech","MA","M.Com", "PHD"};
     ...
     public void actionPerformed(ActionEvent ae){ 
         if(ae.getSource()==add){          
               ...
               String salary = tfaddress.getText();
